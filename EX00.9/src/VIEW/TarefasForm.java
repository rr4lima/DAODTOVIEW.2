 ...
 * @author rafae
 */
public class TarefasForm extends javax.swing.JFrame {

    /**
     * Creates new form TarefasForm
     */
    public TarefasForm() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnAdc.setText("Adicionar Tarefa");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtDescricao, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 118, Short.MAX_VALUE)
    ...
    private void btnAdcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdcActionPerformed
        TarefasDTO t1 = new TarefasDTO(txtTitulo.getText(), txtDescricao.getText(), txtPrazo.getText());

        if (t1.getTitulo().trim().isEmpty() || t1.getDescricao().trim().isEmpty() || t1.getPrazo().trim().isEmpty()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TarefasForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TarefasForm().setVisible(true);
            }
        });
    }
